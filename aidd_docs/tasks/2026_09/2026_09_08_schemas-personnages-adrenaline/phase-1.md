...
3. N'extraire un PDF que pour un point que les résumés ne couvrent pas ou contredisent — `zombiology_part_01.pdf`, `zombiology_part_06.pdf`, `Z1L05_Livret PNJ et animaux.pdf`, puis `Z1L01_Contamination_Ldb.pdf` en dernier recours.
