/** Major version of the portable Adrenaline document contract. */
export const ADRENALINE_CONTRACT_VERSION = 1 as const;

/** Exact immutable schema baseline shipped by this contract release. */
export const ADRENALINE_SCHEMA_VERSION = "1.1.0" as const;
